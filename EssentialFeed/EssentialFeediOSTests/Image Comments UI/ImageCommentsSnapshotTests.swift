...
class ImageCommentsSnapshotTests: XCTestCase {
    ...
    func test_listWithComments() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone12(style: .light)), named: "IMAGE_COMMENTS_light")
        assert(snapshot: sut.snapshot(for: .iPhone12(style: .dark)), named: "IMAGE_COMMENTS_dark")
    }
